...
\begin{frame}{Nucleic Acids Research paper}
  ...
  \end{itemize}
  \begin{figure}
    \includegraphics[width=0.65\textwidth,keepaspectratio]{images/alpha-charges-visualization.jpeg}
  \end{figure}
\end{frame}

\begin{frame}{Conclusion}
  \begin{itemize}
    \item created a Mol* extension for visualizing partial atomic charges
    \item integrated the updated Mol* Viewer into ACC~II and αCharges
    \item extended the capabilities of both web applications
